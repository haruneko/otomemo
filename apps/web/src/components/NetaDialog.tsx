...
export function NetaDialog({
  ...
  return (
    ...
    >
      ...
      <KindEditorBody
        neta={neta}
        flags={{ isMelody: f.isMelody, isBass: f.isBass, isCounter: f.isCounter, isRiff: f.isRiff, isChord: f.isChord, isChordPat: f.isChordPat, isRhythm: f.isRhythm, isSkel: f.isSkel, isContainer: f.isContainer, isRelBass: f.isRelBass }}
