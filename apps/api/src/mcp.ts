...
export function buildMcpServer(core: Core, opts: { surface?: "chat" | "full" } = {}): McpServer {
  ...
  server.registerTool(
    ...
    async ({ frame, chords, seed, drums, kickLock, snareGap, approach, style, fill, slashBass, swing, humanize, relative, skeletonNetaId, respondToCues, anchorLock, anchorRestOnSyncopatedKick, chordFollow }) => {
      ...
      const res = genBass(frame, chords, seed, drums, { kickLock, snareGap, approach, skeleton, style, fill, slashBass, swing, humanize, relative, respondToCues, anchorLock, anchorRestOnSyncopatedKick, chordFollow });
