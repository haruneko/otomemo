...
最終更新: 2026-07-12（骨格の机 S6 設計確定＝B本格/E遷移試聴/机後続を追記）
...
- **骨格の机（design #20 S6・2026-07-12設計確定）から明示的に送った分**（実装スライスD0〜D6は `docs/research/2026-07-12-skeleton-desk-handoff.md`・着手したらTask化）：
  ...
  - **机の後続小物**：3/4・6/4 の snap 表（付点系）・句単位再抽選（「句2だけ引き直す」）・②レンズ「和声だけ」の voicing 込み化。
