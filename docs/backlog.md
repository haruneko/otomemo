...
- **［オーナー裁定待ち 2026-09-16］リフ撤去の後始末2件**（`docs/archive/2026-09-16-riff-arc-revert-review.md` §7 ③④・撤去そのものは裁定済み・完了）：
  ③ phrase_maker 取り込みアークを**ドラム＋JZ-WALK＋検証器で完走扱い**にし M6b〜M7 と旧 §8 の裁定4件（ケルト／鍵盤の置き場／band 契約／要件1行）を打ち切るか（レビューの見立て＝打ち切り）／
  ④ 次は上の **S2 配札・S3 リフ雛形へ戻る**か（入口＝既存 `gen_riff`＋和声4型＋配札）。戻る起点＝`docs/drafts/2026-08-02-arrange-arc-handoff.md`。
