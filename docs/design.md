...
- **［耳/手］未消化（D1〜D3・オーナー実機）**：D1＝①レンズ無停止切替の滑らかさ（核）②打点スクロール誤爆③クリック音量。D2＝④指摘文が「禁止でなく味」に読めるか⑤ダイアッド持続/音量で不協和が聴き取れるか。D3＝⑥コード試着で③の響き変化がループを止めず耳で追え採用で鳴り直すのが妥当か⑦導出ベース線が「②が下声を決める」と読めるか。**フィール既定（クリック vel90/55・SAVE_DEBOUNCE500ms・ダイアッド0.8拍・reloop発火点等）は暫定＝耳較正で見直し可**。
- **残スライス**：D4 ④出口トレイ（吹く→試着→置く＋分岐スタック）／D5 ①ビート前景＋レンズのステージ相対一般化／D6 B-lite。
