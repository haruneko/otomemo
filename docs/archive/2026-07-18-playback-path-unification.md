...
関連正典：design.md #24（再生開始の非ブロック契約）・#25（弱起の再生契約）・docs/archive/2026-07-16-vocal-consonant-countin.md（子音カウントイン）・backlog.md「FormStrip つなぎ試聴が仮歌を通していない」（片付け節・2026-07-17 F1監査#5）。
